...
class BrandsLogin extends GenericClass {
    ...
    private final By USER_PROFILE_ICON_CLICK = By.xpath(".//span[@class='glyphicon glyphicon-user']");.//*[@id='storefrontHeader']/div[2]/a
    private final By STOREFRONT_CLICK = By.xpath(".//span[@class='glyphicon glyphicon-user']");
