...
class HomePage extends GenericClass{
    ...
    private final By QUICK_VIEW = By.xpath(".//div[@class='container homepage ng-scope']/div[5]/div/div/div/div/ul/li[2]/a/div[1]/div[3]");
    ...
    {
        Stopwatch pageLoad = Stopwatch.createStarted();
		navigateToUrl();
		pageLoad.stop();
